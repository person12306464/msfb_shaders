...
float ___BUFFER_ASPECT_RATIO___()
{
    return float(BUFFER_WIDTH / BUFFER_HEIGHT);
}

int ___MAX_BLUR_NUM_TOTAL_SAMPLES___()
{
    return int(___MAX_BLUR_NUM_SAMPLES___ * ___MAX_BLUR_NUM_SAMPLES___);
}

float ___MAX_BLUR_NUM_TOTAL_SAMPLES_RCP___()
{
    return float(1.0 / ___MAX_BLUR_NUM_TOTAL_SAMPLES___());
}

int ___BUFFER_SIZE_DIVIDER___()
{
    return int(1 << ___BUFFER_SIZE_MAX_BIT_SHIFT___);
}

float ___ONE_THIRD___()
{
...
float ___STEP_MULTIPLIER___()
{
    return float(1.5);
}

float ___BUFFER_SIZE_DIVIDER_COMPENSATION_OFFSET___()
{
    return float(___BUFFER_SIZE_DIVIDER___() * ___STEP_MULTIPLIER___());
}

float2 ___SCALED_BUFFER_SIZE_DIVIDER_DIVIDER_COMPENSATION_OFFSET___()
{
    return float2(___BUFFER_SIZE_DIVIDER_COMPENSATION_OFFSET___() * BUFFER_PIXEL_SIZE);
}
